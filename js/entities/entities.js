game.BirdEntity = me.Entity.extend({
    init: function (x, y) {
        ...
        var sz = game.data.customSpriteSize;
        settings.width = sz ? sz.w : 85;
        settings.height = sz ? sz.h : 60;
        ...
        this.body.addShape(new me.Ellipse(5, 5, settings.width - 14, settings.height - 9));
